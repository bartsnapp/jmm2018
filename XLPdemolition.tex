\documentclass {article} \usepackage [paperwidth=2in, paperheight=2in,margin=0in]{geometry} \begin {document} \pagestyle {empty}\flushleft 
\special {ximera:filename xa}
